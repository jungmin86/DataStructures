...
//  LAB12_#1
//
//  Created by Jungmin Kim on 2023/05/26.
//
...
int main(int argc, const char * argv[]) {
    ...
    cout << "Weight of 'vertebrate to animal' is " << graph.WeightIs("vertebrate", "animal") << endl; //10
    cout << "Weight of 'poodle to dog' is " << graph.WeightIs("poodle", "dog") << endl; //90
